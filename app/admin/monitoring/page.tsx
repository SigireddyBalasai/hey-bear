        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            >
              {overallStatus === "operational" ? (
                <>
                  <CheckCircle className="mr-1 h-4 w-4" /> All Systems
                  Operational
                </>
              ) : overallStatus === "degraded" ? (
                <>
                  <AlertTriangle className="mr-1 h-4 w-4" /> Degraded
                  Performance
                </>
              ) : (
                <>
                ...
                <div className="rounded-md border p-3">
                  <div className="flex justify-between mb-1">
                    <span className="font-medium">
                      AI Model Service Degraded
                    </span>
                    <Badge variant="outline">2 hours ago</Badge>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    Increased latency observed in AI model responses due to high
                    traffic volume.
                  </p>
                </div>
                <div className="rounded-md border p-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Brief connectivity issues with the database caused
                    intermittent errors. Resolved within 5 minutes.
                  </p>
                </div>
