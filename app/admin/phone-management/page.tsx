...
import { Phone, ChevronLeft, Settings, Link2, HelpCircle } from "lucide-react";
        ...
        {!isSettingsLoading &&
          ...
          activeTab !== "settings" && (
            <Alert className="mb-6 border-amber-500 text-amber-600 [&>svg]:text-amber-600">
              ...
              <AlertDescription>
                Configure your Twilio API credentials to enable phone management
                functionality.
              </AlertDescription>
            </Alert>
          )}
            ...
            {!twilioConfigured ? (
              <div className="text-center py-12 bg-muted/30 rounded-lg border border-dashed">
                ...
                <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                  Please configure your Twilio API credentials before managing
                  phone numbers.
                </p>
          ...
          <TabsContent value="twilio">
            {!twilioConfigured ? (
              <div className="text-center py-12 bg-muted/30 rounded-lg border border-dashed">
                ...
                <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                  Please configure your Twilio API credentials to view and
                  manage your Twilio account phone numbers.
                </p>
                <Button onClick={() => setActiveTab("settings")}>
                  Configure API Settings
                </Button>
