      ...
      <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto">
        <DialogHeader className="space-y-3">
          <DialogTitle className="text-2xl flex items-center gap-3">
            <Avatar className="h-10 w-10">
              ...
              <AvatarFallback>
                {getInitials(userData.users?.full_name)}
              </AvatarFallback>
            </Avatar>
          ...
          <DialogDescription className="flex items-center gap-2 text-sm">
            ...
            Member since{" "}
            {formatDate(userData.users?.created_at || userData.date)}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <Card className="overflow-hidden border-l-4 border-l-purple-500">
            <CardHeader className="pb-2">
              ...
              <div className="flex justify-between items-center">
                <CardTitle className="text-2xl">
                  {userData.token_usage?.toLocaleString() || 0}
                </CardTitle>
        ...
        <Tabs defaultValue="summary">
          <TabsList className="grid grid-cols-3 mb-4">
            ...
            <TabsTrigger value="Concierge">No-show</TabsTrigger>
          ...
          <TabsContent value="No-show">
            <Card>
              <CardHeader>
                ...
                <CardDescription>No-show created by this user</CardDescription>
              </CardHeader>
              <CardContent className="text-center py-10">
                <Shield className="mx-auto h-16 w-16 text-muted-foreground/30 mb-4" />
                <p className="text-lg font-medium">No No-show data available</p>
                <p className="text-sm text-muted-foreground mt-1">
                  No-Show usage data will appear here when available
                </p>
              </CardContent>
