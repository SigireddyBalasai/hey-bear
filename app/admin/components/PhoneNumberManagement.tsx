                      ...
                      >
                        ...
                        <div className="flex justify-end gap-2">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleUnassignPhoneNumber(phone.number)
                            }
                          >
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4">
                ...
                >
                  ...
                  {isAssigning
                    ? "Assigning Number..."
                    : "Assign Number from Country"}
                </Button>

                <div className="bg-blue-50 border border-blue-200 p-4 rounded-md text-sm text-blue-800">
                  <p className="font-medium">Important Note</p>
                  <p className="mt-1">
                    A phone number will be automatically selected from the
                    chosen country and assigned to your assistant. If no number
                    is available in our pool, one will be purchased from Twilio.
                  </p>
                  <p className="mt-1">
                    Purchasing numbers will immediately charge your Twilio
                    account. Make sure you have proper billing setup in your
                    Twilio account.
                  </p>
                </div>
              </div>
