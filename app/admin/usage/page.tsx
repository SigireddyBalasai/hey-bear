...
import type { UserStat } from '@/app/admin/utils/adminUtils';
...
export default function UsageAnalyticsPage() {
  ...
  const loadUsageData = useCallback(async (timeframe: string, assistantId: string = selectedAssistant, plan: string = selectedPlan) => {
    setIsLoading(true);
