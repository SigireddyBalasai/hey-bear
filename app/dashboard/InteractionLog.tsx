      ...
      <CardHeader>
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription>
              Detailed insights into how your No-show is interacting with others
            </CardDescription>
          </div>
        </div>
      </CardHeader>
                  ...
                  : interactions.map(
                      (interaction: Interaction, index: number) => (
                        <TableRow
                          ...
                          className={
                            index > 0 &&
                            interaction.date !== interactions[index - 1].date
                            ...
                            {interaction.type
                              ...
                              .map((type: string, i: number) => (
                                <Badge
                                  key={i}
                                  variant={
                                    type === "Inbound" ? "secondary" : "default"
                                  }
                                  className="mr-1"
                                >
                                  {type}
          ...
          <TabsContent value="conversation" className="m-0">
            {isLoading ? (
              ...
              <div className="space-y-4">
                ...
                {Array.from(new Set(interactions.map((i) => i.date))).map(
                  (date, idx) => (
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            {interactions
                              .filter(
                                (i) =>
                                  i.date === date && i.phoneNumber === phone,
                              )
                              .map((interaction, idx) => (
                                  ...
                                  {interaction.response !== "-" && (
                                    <div className="flex justify-end">
                                      <div className="bg-indigo-100 p-3 rounded-lg max-w-md">
                                        ...
                                        <p className="text-xs text-right text-gray-500 mt-1">
                                          {interaction.responseTime} response
                                          time
                                        </p>
                                      </div>
                                    </div>
