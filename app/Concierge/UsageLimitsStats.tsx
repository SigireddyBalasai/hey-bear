...
export default function UsageLimitsStats({
  assistantId,
}: UsageLimitsStatsProps) {
    ...
    async function fetchUsageStats() {
      try {
        ...
        const response = await fetch(
          `/api/Concierge/usage-stats?assistantId=${assistantId}`,
        );
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            {messagePercentage >= 90 && (
              <p className="text-xs text-red-500 mt-1">
                You're running low on messages this month! Consider upgrading
                your plan.
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {documentsPercentage >= 90 && (
              <p className="text-xs text-red-500 mt-1">
                You're approaching your document limit! Consider upgrading your
                plan.
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {webpagesPercentage >= 90 && (
              <p className="text-xs text-red-500 mt-1">
                You're approaching your webpage limit! Consider upgrading your
                plan.
              </p>
            )}
          </div>
          ...
          <div className="text-xs text-gray-500 mt-2">
            Messages reset monthly. Last reset:{" "}
            {formatDate(usageStats.lastReset)}
          </div>
        </div>
      </CardContent>
    </Card>
