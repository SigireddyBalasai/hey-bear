  ...
  return (
    <div className="space-y-4">
          ...
          <Dialog open={dialogOpen} onOpenChange={handleDialogOpenChange}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Choose a country to automatically assign a phone number to
                  this No-show.
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Area code is only used for some countries like the US and
                      Canada
                    </p>
                  </div>
                  ...
                  <div className="bg-muted rounded-md p-3 text-sm">
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      <li>
                        A number will be automatically selected from the chosen
                        country
                      </li>
      ...
      <div className="text-sm text-muted-foreground">
        {currentPhoneNumber ? (
          <p>
            This No-show can receive and respond to SMS messages at this phone
            number.{" "}
