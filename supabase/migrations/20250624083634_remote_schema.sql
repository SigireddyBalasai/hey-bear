...
CREATE OR REPLACE VIEW "public"."assistant_detail_view" AS
 SELECT "a"."id",
   ...
   FROM ((("public"."assistants" "a"
     ...
     LEFT JOIN "public"."assistant_subscriptions" "asub" ON (("a"."id" = "asub"."assistant_id")))
     LEFT JOIN "public"."assistant_activity" "aa" ON (("a"."id" = "aa"."assistant_id")));
...
CREATE POLICY "Allow service_role full access on payment_sessions" ON "public"."payment_sessions" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "admin_users_select_all_assistant_configs" ON "public"."assistant_configs" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_assistant_limits" ON "public"."assistant_limits" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_assistant_subscriptions" ON "public"."assistant_subscriptions" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_assistants" ON "public"."assistants" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_audit_logs" ON "public"."audit_logs" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_historical_usage" ON "public"."historical_usage" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_interactions" ON "public"."interactions" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_payment_sessions" ON "public"."payment_sessions" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_phone_numbers" ON "public"."phone_numbers" FOR SELECT TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "admin_users_select_all_usage_statistics" ON "public"."usage_statistics" FOR SELECT TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "plan_users_delete_own_assistant_configs" ON "public"."assistant_configs" FOR DELETE TO "authenticated" USING ((("id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_delete_own_assistant_subscriptions" ON "public"."assistant_subscriptions" FOR DELETE TO "authenticated" USING ((("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_delete_own_assistants" ON "public"."assistants" FOR DELETE TO "authenticated" USING ((("user_id" = "auth"."uid"()) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_insert_own_assistant_configs" ON "public"."assistant_configs" FOR INSERT TO "authenticated" WITH CHECK ((("id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_insert_own_assistant_subscriptions" ON "public"."assistant_subscriptions" FOR INSERT TO "authenticated" WITH CHECK ((("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_insert_own_assistants" ON "public"."assistants" FOR INSERT TO "authenticated" WITH CHECK ((("user_id" = "auth"."uid"()) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_insert_own_audit_logs" ON "public"."audit_logs" FOR INSERT TO "authenticated" WITH CHECK ((("performed_by" = "auth"."uid"()) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_insert_own_payment_sessions" ON "public"."payment_sessions" FOR INSERT TO "authenticated" WITH CHECK ((("user_id" = "auth"."uid"()) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_update_own_assistant_configs" ON "public"."assistant_configs" FOR UPDATE TO "authenticated" USING ((("id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))) AND (NOT "public"."is_admin"()))) WITH CHECK ((("id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_update_own_assistant_subscriptions" ON "public"."assistant_subscriptions" FOR UPDATE TO "authenticated" USING ((("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))) AND (NOT "public"."is_admin"()))) WITH CHECK ((("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_update_own_assistants" ON "public"."assistants" FOR UPDATE TO "authenticated" USING ((("user_id" = "auth"."uid"()) AND (NOT "public"."is_admin"()))) WITH CHECK ((("user_id" = "auth"."uid"()) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_update_own_or_unassigned_phone_numbers" ON "public"."phone_numbers" FOR UPDATE TO "authenticated" USING (((("assistant_id" IS NULL) OR ("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"())))) AND (NOT "public"."is_admin"()))) WITH CHECK (((("assistant_id" IS NULL) OR ("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"())))) AND (NOT "public"."is_admin"())));



CREATE POLICY "plan_users_update_own_payment_sessions" ON "public"."payment_sessions" FOR UPDATE TO "authenticated" USING ((("user_id" = "auth"."uid"()) AND (NOT "public"."is_admin"()))) WITH CHECK ((("user_id" = "auth"."uid"()) AND (NOT "public"."is_admin"())));
...
CREATE POLICY "users_select_own_assistant_configs" ON "public"."assistant_configs" FOR SELECT TO "authenticated" USING (("id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))));



CREATE POLICY "users_select_own_assistant_limits" ON "public"."assistant_limits" FOR SELECT TO "authenticated" USING (("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))));



CREATE POLICY "users_select_own_assistant_subscriptions" ON "public"."assistant_subscriptions" FOR SELECT TO "authenticated" USING (("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))));



CREATE POLICY "users_select_own_assistant_usage_limits" ON "public"."assistant_usage_limits" FOR SELECT TO "authenticated" USING (("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))));



CREATE POLICY "users_select_own_assistants" ON "public"."assistants" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "users_select_own_audit_logs" ON "public"."audit_logs" FOR SELECT TO "authenticated" USING (("performed_by" = "auth"."uid"()));



CREATE POLICY "users_select_own_historical_usage" ON "public"."historical_usage" FOR SELECT TO "authenticated" USING (("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))));



CREATE POLICY "users_select_own_interactions" ON "public"."interactions" FOR SELECT TO "authenticated" USING ((("user_id" = "auth"."uid"()) OR ("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"())))));



CREATE POLICY "users_select_own_or_unassigned_phone_numbers" ON "public"."phone_numbers" FOR SELECT TO "authenticated" USING ((("assistant_id" IS NULL) OR ("assistant_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"())))));



CREATE POLICY "users_select_own_payment_sessions" ON "public"."payment_sessions" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "users_select_own_usage_statistics" ON "public"."usage_statistics" FOR SELECT TO "authenticated" USING (((("entity_type" = 'user'::"text") AND ("entity_id" = "auth"."uid"())) OR (("entity_type" = 'assistant'::"text") AND ("entity_id" IN ( SELECT "assistants"."id"
   FROM "public"."assistants"
  WHERE ("assistants"."user_id" = "auth"."uid"()))))));
